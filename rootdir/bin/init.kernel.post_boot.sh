...
configure_core_ctl() {
    ...
    if [ -d /sys/devices/system/cpu/cpu7/core_ctl ]; then
        ...
        echo 50  > /sys/devices/system/cpu/cpu7/core_ctl/offline_delay_ms
...
set_schedutil() {
    ...
    [ -e "$BASE/schedutil/up_rate_limit_us" ]    && echo 0         > $BASE/schedutil/up_rate_limit_us
    [ -e "$BASE/schedutil/down_rate_limit_us" ]  && echo 5000      > $BASE/schedutil/down_rate_limit_us
...
configure_cpu() {
    set_schedutil 0 1804800 300000
    [ -e /sys/devices/system/cpu/cpufreq/policy0/schedutil/rtg_boost_freq ] && \
    echo 1248000 > /sys/devices/system/cpu/cpufreq/policy0/schedutil/rtg_boost_freq

    set_schedutil 4 2400000 576000 75
    ...
    set_schedutil 7 2515200 652800 75
...
configure_input_boost() {
    ...
    echo "0:1324800 4:2016000 7:2208000" > /sys/devices/system/cpu/cpu_boost/input_boost_freq
...
configure_memlat() {
    ...
    for device in /sys/devices/platform/soc; do
        ...
        for llccbw in $device/*cpu-llcc-ddr-bw/devfreq/*cpu-llcc-ddr-bw; do
            ...
            echo 350  > $llccbw/bw_hwmon/up_scale
